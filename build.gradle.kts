...
plugins {
    ...
    // Aligner les versions des plugins Kotlin sur la version du Kotlin stdlib (1.9.24)
...
$openStarterVersion")
    ...
    // Flyway pour migrations de BD
    implementation("org.flywaydb:flyway-core")

    // Actuator pour observabilité (optionnel mais recommandé)
